  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start bg-white">
      <section className="flex flex-col items-center justify-start gap-8 min-h-[200vh] min-w-full bg-gradient-to-b from-[#0052d4] to-blue-600">
        <div
          ref={cardRef}
          className="flex min-w-[90%] min-h-[90vh] bg-white rounded-xl flex-col items-center justify-center gap-8 sticky top-[5vh] shadow-xl"
        >
          {/* Navbar */}
          <nav className="flex items-center justify-between p-6 bg-transparent">
            <div className="flex gap-2 items-center">
              ...
              <h1 className="text-2xl font-black flex items-baseline bg-[linear-gradient(to_right,_#0052d4,_#20bdff,_#6fb1fc)] bg-clip-text text-transparent">
                loopey
              </h1>
            </div>
          </nav>
          ...
          {/* Heading */}
          <div className="flex items-center justify-center relate">
            <h2
              ref={text1Ref}
              className="text-8xl font-serif text-center max-w-6xl z-10 text-black"
            >
            ...
            <span
              ref={text2Ref}
              className="text-7xl font-serif text-center text-black absolute"
            >
              Your Feedback
            </span>
          </div>
